...
Write-Host "=== Fixing Dockerfile PATH Issues ===" -ForegroundColor Green
...
Write-Host "Updating Dockerfiles with correct PATH..." -ForegroundColor Yellow
...
Write-Host "`n=== Dockerfiles PATH fixed! ===" -ForegroundColor Green