        ...
        <view class="filter-list">
          ...
          >
            <view class="filter-item">
              ...
              <text class="filter-value">{{ selectedBase?.name || '全部基地' }}</text>
            </view>
          </picker>
          ...
          >
            <view class="filter-item">
              ...
              <text class="filter-value">{{ selectedFormula?.name || '全部配方' }}</text>
            </view>
          </picker>
        </view>
      </scroll-view>
...
export default {
  ...
  computed: {
    ...mapState(useFeedingStore, ['loading']),
  ...
  methods: {
    ...mapActions(useFeedingStore, ['fetchFeedingRecords', 'fetchFormulas', 'fetchFeedingStatistics']),
    ...mapActions(useBaseStore, ['fetchBases']),
