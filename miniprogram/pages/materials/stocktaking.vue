    ...
    <view class="manual-section" v-if="mode === 'manual'">
      ...
      <view class="quantity-input" v-if="selectedMaterial">
        ...
        <view class="current-stock" v-if="currentStock !== null">
          ...
          <text class="diff" :class="getDiffClass()">
      ...
      <view class="records-list">
        ...
        >
          <view class="record-header">
            <view class="record-title">{{ record.material?.name }}</view>
          ...
          <view class="record-content">
            <view class="record-row">
              ...
              <text class="record-value">{{ record.system_stock }} {{ record.material?.unit }}</text>
            </view>
            <view class="record-row">
              <text class="record-label">实际库存:</text>
              <text class="record-value">{{ record.actual_stock }} {{ record.material?.unit }}</text>
            </view>
            <view class="record-row">
              <text class="record-label">差异:</text>
              <text class="record-value" :class="getRecordDiffClass(record)">
                {{ record.difference }} {{ record.material?.unit }}
              </text>
            </view>
