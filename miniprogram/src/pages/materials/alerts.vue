<template>
  <view class="alerts-page">
    ...
    <view class="filter-section">
      ...
      >
        <view class="filter-item">
          <text>{{ selectedType && selectedType.label || '全部类型' }}</text>
          <text class="filter-arrow">▼</text>
        </view>
      </picker>
      ...
      >
        <view class="filter-item">
          <text>{{ selectedStatus && selectedStatus.label || '全部状态' }}</text>
          <text class="filter-arrow">▼</text>
        </view>
      </picker>
    </view>
    ...
    <view class="alerts-list">
      <view 
        ...
        :key="alert.id"
        class="alert-item"
        :class="alert.is_resolved ? 'resolved' : 'active'"
      ...
      >
        ...
        <view class="alert-content">
          ...
          <view class="alert-meta">
            <text class="meta-item">{{ alert.base && alert.base.name }}</text>
          ...
          <view class="detail-section">
            ...
            <view class="detail-grid">
              <view class="detail-item">
                ...
                <text class="detail-value">{{ selectedAlert.material && selectedAlert.material.name }}</text>
              </view>
              <view class="detail-item">
                <text class="detail-label">物资编码</text>
                <text class="detail-value">{{ selectedAlert.material && selectedAlert.material.code }}</text>
              </view>
              <view class="detail-item">
                <text class="detail-label">所属基地</text>
                <text class="detail-value">{{ selectedAlert.base && selectedAlert.base.name }}</text>
              </view>
              <view class="detail-item">
