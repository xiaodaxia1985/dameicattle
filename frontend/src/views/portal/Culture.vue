      ...
      <div class="container">
        <div class="join-content">
          ...
          <div class="join-actions">
            <router-link to="/portal/contact" class="btn btn-primary">联系我们</router-link>
            <a href="mailto:hr@cattle-management.com" class="btn btn-outline">发送简历</a>
          </div>
        </div>
      </div>
    </section>
